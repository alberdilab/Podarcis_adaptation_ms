...
table_upset_analysis_cont=t(aggregate(t(genome_counts_rel_pa),by=list(subset_meta$species),FUN=sum)[,-1])
colnames(table_upset_analysis_cont)=levels(as.factor(subset_meta$species))
